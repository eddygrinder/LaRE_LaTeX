...
Os resultados obtidos experimentalmente usando o circuito montado na placa branca e a simulação no \textit{multisim} estão representados na Figura \ref{fig:realmeiaonda} e Figura \ref{fig:multisimmeiaonda}, respectivamente.
