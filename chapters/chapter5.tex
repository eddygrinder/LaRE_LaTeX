...
Estes valores foram obtidos com recurso ao \acrshort{virtualbench} e demonstram que o valor da resistência, que corresponde ao declive da recta é constante, o que confirma a Lei de Ohm. A partir da Equação \ref{eq:errorelativo}, o valor do erro relativo é inferior a \SI{1}{\percent}. 
...
A Figura \ref{fig:ripplelaremeiaonda} apresenta a forma de onda da tensão de saída e o valor da tensão de \textit{ripple} obtido no \acrshort{lare}, que foi de \SI{423,87}{\milli\volt}.
...
\begin{figure}[hbtp]
	\centering%
		...
		\qquad
		\subfloat[\centering Simulação Multisim\label{fig:multisimmeiaonda}]{{\includegraphics[width=6.3cm]{figures/ripple_multisim_MO-2k2-100uFALT.png} }}%
...
\begin{figure}[hbtp]
	\centering%
		\centering
		\subfloat[\centering Medição - 1N4007\label{fig:ripple1n4007}]{{\includegraphics[width=6.3cm]{figures/ripple_lab_1N4007.jpeg} }}%
		\qquad
		\subfloat[\centering Medição - B250C2300-1500 \label{fig:rippleb250}]{{\includegraphics[width=6.3cm]{figures/ripple_lab_ponte.jpeg} }}%
...
\begin{figure}[hbtp]
	\centering%
		\centering
		\subfloat[\centering Circuito prático\label{fig:realPA}]{{\includegraphics[width=6.3cm]{figures/PA_10nF2k2-80Khz.png} }}%
		\qquad
		\subfloat[\centering Simulação Multisim\label{fig:multisimPA}]{{\includegraphics[width=6.3cm]{figures/boda_HPF_vout.png} }}%
...
\begin{figure}[hbtp]
	\centering%
		\centering
		\subfloat[\centering Circuito prático\label{fig:realfcvout}]{{\includegraphics[width=6.3cm]{figures/PA_10nF2k2-Fc.png} }}%
		\qquad
		\subfloat[\centering Simulação Multisim\label{fig:multisimfcvout}]{{\includegraphics[width=6.3cm]{figures/boda_HPF_vout_fc.png} }}%
