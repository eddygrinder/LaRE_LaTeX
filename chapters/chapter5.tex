...
\begin{equation} \label{eq:vrippleOCTeorico}
	U_{ripple} = \frac{\SI{7}{\volt} - \SI{1.4}{\volt}}{2*\SI{50}{\hertz}*\SI{2.2}{\kilo\ohm}*\SI{100}{\micro\farad}} \approx \SI{254.55}{\milli\volt}
\end{equation}
