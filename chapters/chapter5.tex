...
Analisando os resultados obtidos experimentalmente no \textit{Multisim}, representados na Figura \ref{fig:rippleexperimentalmeiaonda}, a tensão de \textit{ripple} obtida é de, aproximadamente, \SI{1.51}{\volt}.
...
O valor do erro relativo é de \SI{21.35}{\percent}. Esta diferença entre o valor calculado teoricamente e o obtido na simulação do \textit{Multisim} deve-se às simplificações da expressão analítica usada. Esta fórmula assume componentes ideais e condições perfeitas, como uma resistência constante e condensador sem perdas \cite{sedrasmith}. No entanto, o simulador considera comportamentos mais realistas, como a resistência interna do condensador (ESR), quedas de tensão nos díodos e efeitos transitórios. Por isso, a discrepância observada é esperada e perfeitamente aceitável.
