...
O valor obtido para o declive no multisim e circuit lab é $\text{m} \approx{1.0204}$ - como a escala do eixo do x está representada em \SI{}{\milli\ampere} o valor correspondente da resistência é de \SI{1.0204}{\kilo\ohm}. Aplicando a Equação \ref{eq:errorelativo} chega-se a um valor para o erro relativo de \SI{2.24}{\percent}.
