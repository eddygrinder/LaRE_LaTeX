...
Ainda assim e como forma de complementar a análise dos resultados, foram efectuados testes complementares usando, neste caso, o \href{https://www.multisim.com}{\textit{MultisimLive}} e o \href{https://www.circuitlab.com/}{\textit{CircuitLab}}. A Figura \ref{fig:multisim_ohm} e a Figura {fig:} apresentam os resultados obtidos.

\begin{figure}[hbtp]
	\centering%
		\centering
		\subfloat[\centering Multisim\label{fig:multisimOHM}]{{\includegraphics[width=6.3cm]{figures/OHM_resultado_circuitlab.png} }}%
		\qquad
		\subfloat[\centering CircuitLab\label{fig:circuitlab}]{{\includegraphics[width=6.3cm]{figures/ohm_escolha_abc.png} }}%
