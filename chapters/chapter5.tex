...
O erro relativo entre o valor teórico e o valor obtido no \acrfull{lare}, pode ser calculado através da Equação \ref{eq:errorelativo}:
...
Ainda assim e como forma de complementar a análise dos resultados, foram efectuados testes com o \href{https://www.multisim.com}{\textit{MultisimLive}}. A Figura \ref{fig:multisimOHM} mostra o gráfico obtido.
...
Verifica-se, através da análise dos gráficos, que os dados obtidos com o \acrshort{lare} estão em concordância com os resultados simulados e com os valores experimentais.
