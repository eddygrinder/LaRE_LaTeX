...
Como exemplo, no caso de o utilizador ou aluno pretender estudar o rectificador de meia onda ou o de onda completa, os relés seriam activados da forma representada na Tabela \ref{Table:exemplomeiaonda}. 
...
As combinações possíveis com o par resistência/condensadores são quatro. No exemplo referido na tabela anterior, o filtro do rectificador de meia onda é composto 
