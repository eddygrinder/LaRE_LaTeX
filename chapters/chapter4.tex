...
Em termos de organização e desenvolvimento do \textit{hardware} e \textit{software} (abordado nas secções seguintes) dos circuitos, optou-se por dividir as experiências em duas partes: Lei de \textit{Ohm} e Rectificadores/Filtros. 

No \textit{datasheet} encontram-se os esquemas completos das experiências, assim como as placas que constituem o \acrshort{lare}: cada experiência ficou dividida por uma placa, mais uma dedicada às fontes de alimentação, num total de três placas. 
