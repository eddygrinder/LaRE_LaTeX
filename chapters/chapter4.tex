...
Nesta secção, abordam-se de forma mais específica e detalhada os aspectos particulares das experiências. Considerou-se, assim, que a melhor abordagem para estudá-las é através de um exemplo prático e concreto.
...
\subsubsection{Lei de Ohm - Páginas web}
\label{sec:paginas}
...
Como exemplo, apresentam-se nas Figuras \ref{fig:ohm_intro} e \ref{fig:ohm_ctrl} as página de introdução e controlo, respectivamente, da experiência da Lei de \textit{Ohm}.
