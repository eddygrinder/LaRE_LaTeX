...
\begin{equation} \label{eq:confirmacaoVout}
	V_{O} = 1.25 \times (1 + \frac{1000}{330}) \Leftrightarrow V_{O} = \SI{5,037(87)}{\ohm}
\end{equation}
...
Na prática e em contexto de sala de aula, a experiência de rectificação de onda completa levanta um problema de massas. Quer isto dizer que não é possível usar, simultaneamente, o gerador de sinal para alimentar a ponte rectificadora e o osciloscópio para realizar a medição da onda de saída. Como se pode ver pelo esquema representado na Figura {fig:}, o díodo está curto-circuitado. A forma de controlar este problema é usar um transformador e, assim, medir a onda de saída com o osciloscópio, tal como representado no esquema da Figura \ref{fig:ondacompleta-massa}. Ainda assim, não é possível medir a onda de entrada e saída simultaneamente.

No caso do \acrshort{lare}, as massas podem ser controladas por \textit{software}, através dos relés, sendo que seria possível, desta forma, evitar o uso do transformador e usar, em vez disso, o gerador de sinal do \acrshort{virtualbench}. Neste caso, os sinais seriam medidos independentemente e o resultado apresentado numa figura. \textbf{APRESENTAR UM EXEMPLO.}

Sendo assim, o uso do transformador jutifica-se pelas seguintes razões:
\begin{itemize}
