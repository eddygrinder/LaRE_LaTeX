...
\textbf{Posso colocar a parte dos ficheiros aqui nesta parte}

A comunicação faz-se enre os ficheiros que estão definidos na Figura \ref{fig:diagramasimplificado}, sendo que, o comando do \acrshort{virtualbench} é feito através da biblioteca \textit{pyVirtualBench}.
