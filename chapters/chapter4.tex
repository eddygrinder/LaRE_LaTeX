...
Nesta secção, o foco será analisar a comunicação e troca de parâmetros entre os diversos tipos de ficheiros. Na Figura \ref{fig:diagramasimplificado} é apresentado um diagrama que ilustra o funcionamento geral deste tipo de comunicação. 

\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/Diagrama_simplificado.drawio.png}
