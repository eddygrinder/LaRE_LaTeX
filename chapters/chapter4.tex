...
A função ´´STOP()´´ é chamada quando o utilizador selecciona o botão ``STOP'' na página \textit{ohm.html}. Esta função é responsável por desactivar a fonte de alimentação do \acrshort{virtualbench} e desabilitar os selectores dos parâmetros $V_{CC}$ e R.
...
Para se perceber melhor a função deste \textit{script} e das funções descritas em cima, importa clarificar o modo de funcionamento da página \textit{ohm.html}.
