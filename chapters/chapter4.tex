...
Na Figura \ref{fig:blocosrectificacao} está representado o diagrama de blocos geral da rectificação de meia e onda completa, aplicada a uma fonte de tensão \acrshort{cc} . 
...
A tensão de \textit{ripple} é uma componente dependente do tempo que surge à saída do filtro do rectificador - Bloco 3 - sendo que terá de ser minimizada, de forma a estabilizar o valor da tensão de saída \acrshort{cc} - Bloco 4. 

A Figura \ref{fig:sedraripple} representa a forma de onda à saída do Bloco 3 - Filtragem.
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/sedra_ripple.png}
	\caption{Forma de onda à saída do Bloco 3 - Filtragem \cite{sedra}}
	\label{fig:sedraripple}
\end{figure}


De uma forma mais pormenorizada pode ver-se, na Figura (...), a forma de onda à saída do filtro do rectificador de meia onda
