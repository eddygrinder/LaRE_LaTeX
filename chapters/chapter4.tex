...
A tensão de \textit{ripple} é uma componente dependente do tempo que surge à saída do filtro do rectificador - Bloco 3 - sendo que terá de ser minimizada, de forma a estabilizar o valor da tensão de saída \acrshort{cc} - Bloco 4. De uma forma mais pormenorizada pode ver-se, na Figura (...), a forma de onda à saída do filtro do rectificador de meia onda
