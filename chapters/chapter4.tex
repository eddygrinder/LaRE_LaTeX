...
Em termos de organização e desenvolvimento do \textit{hardware} e \textit{software} (abordado nas secções seguintes) dos circuitos, optou-se por dividir as experiências em duas partes: Lei de \textit{Ohm} e Rectificadores e Filtros. 
...
Os esquemas finais, simplificados, estão representados nas Figuras e Figuras
...
Tendo em conta que os rectificadores já se encontravam projectados e testados, considerou-se vantajoso integrar no \acrshort{lare} duas experiências complementares, destinadas ao estudo práctico de filtros passa-alto e passa-baixo. Representados na Figura \ref{fig:filtrosesqgeral} estão os filtros simplificados, leccionados em contexto de sala de aula no ensino secundário.
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/rectificador_filtro_simplificado.png}
	\caption{Esquema completo - rectificador meia onde e filtros}
	\label{fig:rectificacao_filtragem_simplificado}
\end{figure}
