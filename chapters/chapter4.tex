...
A matriz do \acrshort{lare} é constituída por três placas, cujos detalhes técnicos podem ser consultados no Anexo \ref{AppendixA}. 
\begin{comment}
...
A elaboração dos esquemas  e dos \acrfull{pcb} das placas foram elaborados com recurso ao \gls{kicad} e encontram-se representadas no Anexo \ref{AppendixA}. As placas foram desenhadas de forma a serem modulares e estão divididas como representado na Figura \ref{fig:matrizlare}:

\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.4\textwidth]{figures/lare_3placas.jpg}
