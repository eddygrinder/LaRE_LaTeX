...
Após o registo e \textit{login} bem sucedido, é apresentada a página inicial, onde é feito um pequeno resumo do que é o \acrshort{lare} e apresentado o menu de escolha das experiências. O menu de escolha foi retirado do \textit{site} \href{https://www.w3schools.com/howto/howto_js_vertical_tabs.asp}{\textit{w3schools}} e modificado de acordo com as necessidades do projecto, tal como pode ser visto na Figura \ref{fig:pagmenu}.

o utilizador é levado a escolher as experiências. Em cada uma das experieências é fornecida uma pequena explicação do que é pretendido e o que se pretende medir. Estas páginas seguem um modelo uniforme, onde é apresentado o esquema respeitante
