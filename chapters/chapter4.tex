...
\subsubsection{Filtros}
\label{sec:filtros}
A \textit{interface} filtros passa-baixo e passa-alto, é em tudo idêntica à do rectificador de meia onda. Por razões de implementação o utilizador escolhe somente entre dois condensadores, como mostra a Figura XPTO
