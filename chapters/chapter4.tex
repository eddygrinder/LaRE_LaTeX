...
Tendo em conta que os rectificadores já se encontravam projectados e testados, considerou-se vantajoso integrar no \acrshort{lare} duas experiências complementares, destinadas ao estudo práctico de filtros passa-alto e passa-baixo. As modificações feitas foram relativamente simples, uma vez que os blocos de rectificação e filtragem são comuns às duas experiências. Na Figura \ref{fig:filtragemsimplificado} está representado o esquema simplificado dos filtros.

\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.7\textwidth]{figures/filtros_simplificado.png}
