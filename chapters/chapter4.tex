...
\textbf{ATENÇÃO, NÃO ESQUECER REFERIR QUE NOS FILTROS TAMBÉM SE PODE ESTUDAR A RESPOSTA EM FREQUÊNCIA}
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.6\textwidth]{figures/filtros_simplificado.png}
