...
No caso do \acrshort{lare}, as massas podem ser controladas por \textit{software}, utilizando relés. Dessa forma, seria possível evitar o uso do transformador e, em vez disso, usar o gerador de sinal do \acrshort{virtualbench}. No entanto, o uso do transformador justifica-se pelas seguintes razões:
\begin{itemize}
