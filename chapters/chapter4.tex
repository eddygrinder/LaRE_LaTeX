...
Nesta secção, o foco será em analisar a comunicação e troca de parâmetros entre os diversos tipos de ficheiros e o servidor \textit{Flask}, nomeadamente, o ficheiro \textit{views.py}. Na Figura \ref{fig:fluxohm} é apresentado um diagrama que ilustra o funcionamento geral da experiência da Lei de \textit{Ohm}.
...
O procedimeento para efectuar as medições é o seguinte:
\begin{itemize}
	\item 
\end{itemize}
