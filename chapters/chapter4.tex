...
para realizar a forma como +e feita a comunicação posso introduzir o ficheiro configVB.py e explicar como é feita a comunicação entre os ficheiros. aproveito o que já está escrito à frente, crio um parágrado com a descrição do config.py
