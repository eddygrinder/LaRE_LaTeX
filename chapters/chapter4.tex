...
Uma vez que é possível variar a frequência do sinal de entrada, estas experiências permitem estudar a resposta em frequência dos filtros através da análise do Diagrama de \textit{Bode}, aferir a frequência de corte, dada pela Equação \ref{eq:frequenciacorte} e ainda relacionar, por exemplo, o valor da tensão de entrada com a tensão de saída. 
A Figura \ref{fig:diagramabode} representa um exemplo do Diagrama de \textit{Bode} de um filtro passa-alto, obtido no \acrshort{lare}.
