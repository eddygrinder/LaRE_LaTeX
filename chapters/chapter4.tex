...
explicar porque se optou por colocar o botã ``OK'' e não enviar os parâmetros automaticamente, e só efectuar a medição quando se clicar no link medir.
