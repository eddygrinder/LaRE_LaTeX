...
Aqui taovez mudar o título - organização de pastas e ficheiros ou outra merda similar, tipo ``Organização e estrutura de ficheiros'', ``"Visão Geral da Estrutura de Ficheiros"
'' ou ``Estrutura Modular de Pastas e Ficheiros''
...
REFERIR TB AS PÁGINAS HTML?

\subsection{Páginas \textit{Web}}
\label{sec:paginas}
Como foi referido na Secção \ref{sec:frontend}, tentou-se manter as páginas o mais simples, práticas e intuitivas possível. Uma explicação mais pormenorizada foi feita na Secção XPTO. 

A página de entrada

pARA A página HTML, não foi o objectivo de fazer as merdas bonitinhas, mas sim simples e práticas, no fundo o suficiente para provar o conceito do LaRE.
