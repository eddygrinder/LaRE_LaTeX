...
\begin{itemize}
	...
	\item \SI{12}{\volt} (\acrshort{cc}) - utilizada na alimentação dos relés e dos \textit{drivers} de relés;
...
As configurações das fontes são feitas por \textit{software} e podem ser consultadas na Secção \ref{sec:configmedicaoes}.
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/sch_fonte5VB.png}
	\caption{Fontes de tensão do \acrshort{virtualbench}}
	\label{fig:schfonte5VB}
\end{figure}

\subsubsection{Fonte de tensão \SI{12}{\volt} - fixa}
Tal como referido em cima, de forma a simplificar o uso de fontes externas, optou-se por configurar a fonte de \SI{25}{\volt} para \SI{12}{\volt}. 
...
\textbf{NOTA: Irrelevante ou mudar a explicação. Acho que a imagem não diz nada}

\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/sch_fonte12V.png}
