...
Na Figura \ref{fig:blocosrectificacao} está representado o diagrama de blocos geral da rectificação de meia e onda completa, (que pode ser aplicada)/aplicada a uma fonte de tensão \acrshort{cc}. 
...
\begin{figure}[hbtp]
	...
	\caption{Forma de onda à saída do Bloco 3 - Filtragem \cite{sedrasmith}}
