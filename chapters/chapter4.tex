...
\begin{enumerate}
	\item Bloco 1 - Implementado na placa da alimentação, representada no Figura \ref{fig:} \textbf{NOTA: Adicionaor a foto da outra polaca onde está o transformador, fonte e entradas do gerador de sinal}
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/lore_fonte.jpg}
	\caption{Implementação práctica da alimentação}
	\label{fig:placaaçimentacao}
\end{figure}
