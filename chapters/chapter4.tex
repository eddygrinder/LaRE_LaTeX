...
A configuração da fonte de \SI{6}{\volt} está exemplificada na Listagem \ref{lst:limiteI}. A corrente é limitada a \SI{0.5}{\ampere}, tal como se pode ver na linha 5 da mesma Listagem.
...
De forma a alimentar os circuitos com \SI{5}{\volt} e \SI{12}{\volt} fixos, foi projectada uma fonte de alimentação, tal como se pode ver na Figura \ref{fig:schfonte5VB}.
