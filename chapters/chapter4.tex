...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.6\textwidth]{figures/diagramablocosrectificacao.png}
...
As Figuras \ref{fig:Bode_pb} e \ref{fig:Bode_pa} representam os Diagramas de \textit{Bode} \textins{ideal}, sendo que o que se pretende 
