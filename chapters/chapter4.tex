...
\subsubsection{Ligação entre placas e alimentação}
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.3\textwidth]{figures/lare_3placas.jpg}
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/lare_conectores.png}
...
\textbf{NOTA: Colocar só os conectores ou a foto do lare já montado?}
