...
%A título de exemplo, a página sobre a Lei de Ohm, que é apresentada ao utilizador, está representada na Figura \ref{fig:ohm_intro}.
...
% No entanto, no que diz respeito ao controlo das experiências, tal como referido na Secção \ref{sec:interfaceweb}, a experiência da Lei de Ohm apresenta um maior grau de complexidade, dado que há um número maior de parâmetros e o utilizador ou aluno tem um controle mais amplo sobre a experiência.
