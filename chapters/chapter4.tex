...
Na Figura \ref{fig:meiaondasimplificado} está representado o diagrama de blocos geral da rectificação de meia e onda completa.

\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/ondacompleta.png}
...
Os componentes representados no rectângulo a tracejado magenta, representam 
