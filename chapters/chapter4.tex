...
Tendo em conta que os retificadores já se encontravam projetados e testados, considerou-se vantajoso integrar no \acrshort{lare} duas experiências complementares, destinadas ao estudo prático de filtros passa-alto e passa-baixo. As modificações feitas foram relativamente simples, uma vez que os blocos de rectificação e filtragem são comuns às duas experiências.

\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.7\textwidth]{figures/filtros.png}
	\caption{Esquema dos rectificadores simplificado}
	\label{fig:rectificadoresimplificado}
\end{figure}
