...
\begin{itemize}
	...
	\item \SI{0}{\volt} - \SI{6}{\volt} variáveis (\acrshort{cc}) - utilizada na experiência da Lei de Ohm;
	\item Para o estudo dos circuitos rectificadores e filtros utilizou-se um transformador \SI{220}{\volt}/\SI{8}{\volt} \acrshort{ca}.
\end{itemize}

Como pode ser visto na Figura \ref{fig:paineldianteiro} - \textbf{Esta fig já está representada no cap3} - ou na Figura \ref{fig:promenorfontes} com mais pormenor, o \acrshort{virtualbench} possuí três fontes de alimentação (variáveis): \SI{+6}{\volt}, \SI{+25}{\volt} e \SI{-25}{\volt}.
