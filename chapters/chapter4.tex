...
(\textbf{Confirnmar se a frase seguinte já foi referida} Como já foi referido na Secção??, o rectificador de meia onda é alimentado pelo gerador de sinal e o rectificador de onda completa pelo transformador. Na Os componentes no rectângulo tracejado cor-de-laranja, representado na Figura \ref{fig:rectificadoresimplificado}, compõem o Bloco 3 - Filtragem - e são comuns às duas experiências, sendo que o Bloco 4 - Estabilização - não está montado/projectado, visto que o objectivo é o estudo da variação da tensão de \textit{ripple}. \textbf{verificar se com a FREQUÊNCIA}.

O Bloco 2 - Rectificação - representado na Figura \ref{fig:rectificadoresimplificado} através dos rectângulos tracejados vermelhos, é diferente nas duas experiências, sendo que no caso do rectificador de meia onda, é composto por um díodo e no caso do rectificador de onda completa, por uma ponte rectificadora. 

\paragraph{Rectificador de meia-onda}
\label{sec:meia-onda}
O estudo desta experiência tem como base o circuito representado na Figura \ref{fig:rectificadoresimplificado}, sendo que o rectificador de meia-onda é composto 
