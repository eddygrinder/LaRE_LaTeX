...
Nas páginas introdutórias, o modelo é uniforme para todas as experiências, apresentando o respectivo esquema e contextualização da actividade. No entanto, no que diz respeito ao controlo das experiências, tal como referido na Secção \ref{sec: interfaceweb}, a experiência da Lei de \textit{Ohm} apresenta um maior grau de complexidade, dado que há um número maior de parâmetros e o utilizador ou aluno tem um controle mais amplo sobre a experiência.
\begin{itemize}
	\item ``Introdução'' -  O modelo da página é uniforme para todas as experiências, apresentando o respectivo esquema e contextualização da actividade;
	\item ``Controlo'' - onde o utilizador pode escolher os parâmetros da experiência e as medições a efectuar.
\end{itemize}

As páginas de Introdução seguem o mesmo 
