...
O Bloco 2 - Rectificação - é diferente nas duas experiências, sendo que no caso do rectificador de meia-onda, é composto por um díodo e no caso do rectificador de onda completa, por uma ponte rectificadora. TALVEZ FAZER UMA REBIENGA e NO BLOCO VERMELHO APRESENTAR OS DOIS rectificadores

SE CALHAR COLOCAR O ESQUEMA SIMPLIFICADO DO RECTIFICADOR DE ONDA COMPLETA. 

\paragraph{Rectificador de meia-onda}
\label{sec:meia-onda}
O estudo desta experiência tem como base o circuito representado na Figura \ref{fig:meiaondasimplificado}, sendo que o rectificador de meia-onda é composto 
