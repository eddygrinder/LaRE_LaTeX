...
Estas duas representações têm algumas diferenças ao nível da nomenclatura. Sendo que Zutin, \textit{et al.},(2010), \cite{zutinlab2go}, introduzem os conceitos de \textit{Hybrid Laboratories} e \textit{Hybrid Online Laboratories}.
