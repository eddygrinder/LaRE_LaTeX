...
\label{sec:driver}
O circuito integrado ULN2003A é um \textit{driver}\footnote{Doravante, sempre que for referido \textit{driver} de relés, subentende-se o circuito integrado \textit{ULN2003A}.} muito usado para controlar relés. Além disso estava disponível em contexto laboratorial.
