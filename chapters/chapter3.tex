...
Em contexto de laboratório estavam disponíveis os modelos PI2 e PI3, algo desactualizados. O PI3 já se mostrou lento nos primeiros testes e, por isso, optou-se pela última versão do \textit{RaspberryPI}\footnote{Doravante, sempre que for referido \textit{RaspberryPI}, subentende-se a versão 5.}, que à data da escrita desta dissertação é a versão 5.
...
\begin{figure}[hbtp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/reles.png}
...
\begin{figure}[hbtp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/2003A_Darling.png}
