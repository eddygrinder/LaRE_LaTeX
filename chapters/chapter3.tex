...
\begin{figure}[hbtp]
	\centering%
		...
		\qquad
		\subfloat[\centering Esquema rectificador \label{fig:sedraripple}]{{\includegraphics[width=5cm]{figures/meia_onda_Sedra.png} }}%
