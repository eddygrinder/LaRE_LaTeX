...
Comum às versões anteriores, o \gls{RaspberryPI} possui um conector de 40 pinos denominados \acrfull{gpio}s, como se pode ver na Figura \ref{fig:gpio}.


REFERIR O QUE SÃO GPIOS

que podem ser usados para controlar relés, sensores, motores, etc. Estes pinos são alimentados a \SI{3.3}{\volt} e podem fornecer uma corrente máxima de \SI{16}{\milli\ampere} por pino. A corrente total fornecida por todos os pinos não deve exceder os \SI{272}{\milli\ampere} \cite{Raspberrytech}.
