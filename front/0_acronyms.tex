...
\newacronym{unesco}{UNESCO}{\textit{United Nations Educational, Scientific and Cultural Organization}}
...
\newacronym{steam}{STE(A)M}{\textit{Science, Technology, Engineering, Arts and Mathematics}}
\newacronym{ocde}{OCDE}{Organização para a Cooperação e Desenvolvimento Económico}
\newacronym{pisa}{PISA}{\textit{Program for International Student Assessment}}
\newacronym{covid-19}{COVID-19}{Doença por Coronavírus 2019}
\newacronym{pafse}{PAFSE}{\textit{Partnerships for Science Education}}
\newacronym{visir}{VISIR}{\textit{Virtual Instrument Systems in Reality}}
\newacronym{spice}{SPICE}{\textit{Simulation Program for Integrated Circuits Emphasis}}
\newacronym{pspice}{PSPICE}{\textit{Personal Computer Simulation Program for Integrated Circuits Emphasis}}
\newacronym{pc}{PC}{\textit{Personal Computer}}
\newacronym{ca}{CA}{Corrente Alternada}
\newacronym{cc}{CC}{Corrente Contínua}
\newacronym{bth}{BTH}{\textit{Blekinge Institute of Technology}}
...
\newacronym{labview}{LabVIEW}{\textit{Laboratory Virtual Instrument Engineering Workbench}}
...
\newacronym[sort=i2c]{i2c}{$I^{2}$C}{\textit{Inter-Integrated Circuit}}
...
\newacronym{ajax}{AJAX}{\textit{Asynchronous JavaScript e XML}}
