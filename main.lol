...
\babel@toc {portuguese}{}\relax 
\contentsline {lstlisting}{\numberline {3.1}{\ignorespaces Exemplo \acrshort {css} incluído na página \acrshort {html} \cite {Startingcss}}}{70}{lstlisting.3.1}%
...
\contentsline {lstlisting}{\numberline {4.10}{\ignorespaces Recepção de parâmetros}}{93}{lstlisting.4.10}%
...
\contentsline {lstlisting}{\numberline {4.14}{\ignorespaces Instanciação da classe \textit {PyVirtualBench}}}{97}{lstlisting.4.14}%
...
\contentsline {lstlisting}{\numberline {4.17}{\ignorespaces Gráfico Corrente \textit {vs} Tensão}}{99}{lstlisting.4.17}%
