...
\contentsline {lstlisting}{\numberline {4.17}{\ignorespaces Teste do parâmetro ``OK'' (\ldots e ``STOP'') no ficheiro \textit {views.py}}}{102}{lstlisting.4.17}%
...
\contentsline {lstlisting}{\numberline {4.21}{\ignorespaces Procedimento de medição}}{105}{lstlisting.4.21}%
